    ...
    >
      <RevealOnScroll>
        <div className="max-w-5xl mx-auto px-4">
          <h2 className="text-3xl font-bold mb-8 text-slate-200 text-center">
            {" "}
            Featured Projects
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            "
            >
              <h3 className="text-xl font-bold mb-2">Role-Based Data Dashboard</h3>
              <p className="text-gray-400 mb-4">
                Displays data based on the position of the User.
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
                {["Javascript", "TailwindCSS", "React"].map((tech, key) => (
                  <span
                    key={key}
                    className="
            ...
            >
              ...
              <p className="text-gray-400 mb-4">
                Front-end design based on Netflix with top Shows and Movies.
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
                {["Javascript", "TailwindCSS", "React"].map(
                  (tech) => (
                    <span
                      key={tech}
                      className="
